...
def main():
    ...
    gui.create_button(x=520, y=870, text='NET INCOME', bg='#007bff')
    gui.create_button(x=610, y=870, text='SAVE', bg='#17a2b8', fg='black')
    gui.create_button(x=700, y=870, text='UPDATE', bg='#17a2b8', fg='black')
    gui.create_button(x=790, y=870, text='NEW', bg='#ffc107', fg='black')
