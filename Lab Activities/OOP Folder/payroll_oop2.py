...
class Employee_Salary:
    ...
    def get_overtime_pay(self, emp_rate_per_hour, emp_hour_overtime):
        self.overtime_pay = emp_rate_per_hour * emp_hour_overtime
        return self.overtime_pay

    def get_tardiness_deduction(self, emp_rate_per_hour, emp_tardiness_num_hours):
        self.tardiness_deduction = emp_rate_per_hour * emp_tardiness_num_hours
